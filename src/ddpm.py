...
class DDPMSampler:
    def __init__(self, generator: torch.Generator, num_training_steps: int = 1000, beta_start: float = 0.00085,
    ...
    def set_inference_timesteps(self, num_inference_steps=50):
        ...
        step_ratio = self.num_inference_steps // num_inference_steps
    ...
    def _get_variance(self, timestep: int) -> torch.Tensor:
        ...
        alpha_prod_t_prev = self.alpha_cumprod[prev_t] if prev_t >= 0 else self.one
        current_beta_t = 1 - alpha_prod_t_prev / alpha_prod_t_prev
